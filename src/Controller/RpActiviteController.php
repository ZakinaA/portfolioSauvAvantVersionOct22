...
class RpActiviteController extends AbstractController
{
    ...
    public function rpActiviteList(Request $request, $idRp): Response
    {
        ...
        //idRpActivite est différent de 0, on veut donc modifier une rpActiicite existante
        {
            ...
            {
                return $this->render('rp/listActivites.html.twig', array('idRp'=> $rp->getId(),'rp'=> $rp, 'templateTwigParent' => 'baseEnseignant.html.twig'));
            }
            else
            {
                ...
                return $this->render('rp/listActivites.html.twig', array('idRp'=> $rp->getId(),'rp'=> $rp, 'templateTwigParent' => 'baseEtudiant.html.twig'));
            }
    ...
    public function rpActiviteEdit(Request $request, $idRpActivite): Response
    {
        ...
        //idRpActivite est différent de 0, on veut donc modifier une rpActivite existante
        {
            ...
            if ($formAct->isSubmitted() && $formAct->isValid()) 
            {
                ...
                return $this->redirectToRoute('rpActiviteList', ['idRp'=> $rpActivite->getRP()->getId(), 'rp' => $rpActivite->getRP()]);
            
            }
            else
            {
                return $this->render('rp/addEditActivite.html.twig', array('idRp'=> $rpActivite->getRP()->getId(),'form' => $formAct->createView(), 'rp' => $rpActivite->getRP(), 'pCompetences' => $competences, 'pActivites' => $activite));
    ...
    public function rpActiviteAdd(Request $request, $idRp): Response
    {
	    ...
	    if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('rpActiviteList', ['rp' => $rp, 'idRp'=> $rp->getId()]);
            
	    }
	    else
        {
            return $this->render('rp/addEditActivite.html.twig', array('form' => $form->createView(), 'rp' => $rp));
	    }
    }
