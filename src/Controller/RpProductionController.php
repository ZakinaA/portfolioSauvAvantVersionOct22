...
class RpProductionController extends AbstractController
{
    ...
    public function rpProductionList($idRp): Response
    {
        ...
        //idRpActivite est différent de 0, on veut donc modifier une rpActiicite existante
        {
            ...
            {
                return $this->render('rp/listProductions.html.twig', array('rp'=> $rp, 'templateTwigParent' => 'baseEnseignant.html.twig', 'idRp'=> $rp->getId()));
            }
            else
            {
                ...
                throw $this->createAccessDeniedException();
                    ...
                    return $this->render('rp/listProductions.html.twig', array('rp'=> $rp, 'templateTwigParent' => 'baseEtudiant.html.twig', 'idRp'=> $rp->getId()));
            }
        }
    }
    ...
    public function rpProductionEdit(Request $request, $idProduction): Response
    {
        ...
        //idProduction est différent de 0, on veut donc modifier une production existante
        {
            ...
            if ($form->isSubmitted() && $form->isValid()) 
            {
                ...
                return $this->redirectToRoute('rpProductionList', ['rp' => $prod->getRP(), 'idRp'=> $prod->getRP()->getId()]);
            
            }

            return $this->render('rp/addEditProduction.html.twig', array('form' => $form->createView(), 'rp' => $prod->getRP(), 'idRp' => $prod->getRP()->getId()));
        }
    }
    ...
    public function rpProductionAdd(Request $request, $idRp): Response
    {
	    ...
	    if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('rpProductionList', ['idRp' => $idRp, 'rp'=>$rp]);
            
	    }
	    else
        {
            return $this->render('rp/addEditProduction.html.twig', array('form' => $form->createView(), 'idRp' =>$idRp, 'rp'=>$rp));
	    }
    }
