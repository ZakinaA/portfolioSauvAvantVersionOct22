...
class Stage
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=SemaineStage::class, mappedBy="stage", orphanRemoval=true)
     * 
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity=Pointage::class, mappedBy="stage", orphanRemoval=true)
     */
    private $pointages;
