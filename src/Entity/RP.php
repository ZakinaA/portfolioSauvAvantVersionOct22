...
class RP
{
     ...
     */
    // propriété permettant de savoir si la rp est affecté à cet enseignant
    private $enseignant;

    /**
     * @ORM\ManyToOne(targetEntity=Enseignant::class, inversedBy="rpsEnseignant")
     */
    // enseignant créateur d'une rp exemple
    private $rpEnseignant;
    ...
    public function getRpEnseignant(): ?Enseignant
    {
        return $this->rpEnseignant;
    }

    public function setRpEnseignant(?Enseignant $rpEnseignant): self
    {
        $this->rpEnseignant = $rpEnseignant;
