...
class SemaineStage
{
     ...
     * @Assert\Length(max = 255, maxMessage = "La zone apprentissage doit comporter au maximum 255 caractères")
     */
    private $apprentissage;

    /**
     * @ORM\Column(type="string", length=255, nullable=true)
     * @Assert\Length(max = 255, maxMessage = "La zone bilan doit comporter au maximum 255 caractères")
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity=TacheSemaine::class, mappedBy="semaineStage",  orphanRemoval=true)
